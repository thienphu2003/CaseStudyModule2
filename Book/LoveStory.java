...
public class LoveStory implements Book {
    private String title;
    private String author;
    private String isbn;
    private double price;
    private String category="LoveStory";
    ...
    public LoveStory(BookBuilder builder) {
    ...
    public static class BookBuilder{
        ...
        public LoveStory build()
        {
            return new LoveStory(this);
        }
